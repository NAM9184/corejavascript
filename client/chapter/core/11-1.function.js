...
function calcPrice(
  ...
  //   if (!priceA || !priceB) {
  //     throw new Error(
  //       `calcPrice 합수의 첫 번째와 두 번째 인수는 필수 입력값 입니다.`
  //     );
  //   }
...
function getStyle(node, prop) {
  ...
  if (typeof node !== "string") {
    throw new Error("getStyle 함수의 두번째 인수는 문자 타입 이어야 합니다.");
  }
...
// function setStyle(){
//   let colorChange = document.querySelector('.first');
//   let value = '#';
//   let valuecolor = value + prompt();
//   console.log(valuecolor);
//   return colorChange.style[valuecolor] = '#ccc';
